...
import com.muyi.common.sms.core.client.impl.aliyun.AliyunSmsClient;
import com.muyi.common.sms.core.client.impl.tencent.TencentSmsClient;
import com.muyi.common.sms.core.enums.SmsChannelEnum;
...
public class SmsClientFactoryImpl implements SmsClientFactory {
	 ...
	 *
	 * 注意，一些场景下，需要获得某个渠道类型的客户端，所以需要使用它。 例如说，解析短信接收结果，是相对通用的，不需要使用某个渠道编号的
	 * {@link #channelIdClients}
	 */
