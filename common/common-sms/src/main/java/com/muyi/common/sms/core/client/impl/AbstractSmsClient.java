package com.muyi.common.sms.core.client.impl;

import com.muyi.common.core.dto.KeyValue;
import com.muyi.common.sms.core.client.SmsClient;
...
public abstract class AbstractSmsClient implements SmsClient {
	...
	@Override
	public final SmsCommonResult<SmsSendRespDTO> sendSms(Long logId, String mobile, String apiTemplateId,
		...
		try {
			...
			// 打印异常日志
			log.error("[sendSms][发送短信异常，sendLogId({}) mobile({}) apiTemplateId({}) templateParams({})]", logId, mobile,
					apiTemplateId, templateParams, ex);
			// 封装返回
	...
	protected abstract SmsCommonResult<SmsSendRespDTO> doSendSms(Long sendLogId, String mobile, String apiTemplateId,
