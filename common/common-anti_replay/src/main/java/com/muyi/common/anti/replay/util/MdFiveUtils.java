package com.muyi.common.anti.replay.util;
...
public class MdFiveUtils {
	...
	public static String digest(final String salt, final String nonce, final String url, final Long timestamp,
			final String token, final Object... arguments) {
		return digest(salt, nonce, url, timestamp, token, null, arguments);
	}

	public static String digest(final String salt, final String nonce, final String url, final Long timestamp,
			final String token, final String params, final Object... arguments) {
	...
	private static String argumentsSort(final Object... arguments) {
		if (arguments != null && arguments.length > 0) {
			return Arrays.stream(arguments).map(obj -> {
